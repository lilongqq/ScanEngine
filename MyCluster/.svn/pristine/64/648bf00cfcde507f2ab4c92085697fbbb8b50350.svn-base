...
class Lotus(Client):
    ...
    def __init__(
        ...
        self.protocol = TMultiplexedProtocol.TMultiplexedProtocol(self.binary_protocol, self.service_name)
        ...
        while True:
            if len(self.files) > 0:
                ...
                if 'children' in self.node:
                    ...
                    metadata = self.client.get_metadata(self.node['user'], self.node['index'])
                    ...
                    xml = self.client.get_xml(self.node['user'], self.node['index'])
                    ...
                    for item in items:
                        ...
                        if file is not None:
                            ...
                            filedata = file.find(self.variables.lotus['file']['filedata'])
