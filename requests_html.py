...
class BaseSession(requests.Session):
    ...
    async def browser(self):
        if not hasattr(self, "_browser"):
            self._browser = await pyppeteer.launch(ignoreHTTPSErrors=not(self.verify), headless=True, args=self.__browser_args, handleSIGINT=False, handleSIGTERM=False, handleSIGHUP=False)
